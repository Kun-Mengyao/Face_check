            ...
            for i in range(4):
                if Capture.isOpened():
                    ...
                    if len(left_pos) != 0 and len(right_pos) != 0:
                        left_pred = predict(frame[left_pos[1]:left_pos[1]+left_pos[3],left_pos[0]:left_pos[0]+left_pos[2]],model)
                        right_pred = predict(frame[right_pos[1]:right_pos[1]+right_pos[3],right_pos[0]:right_pos[0]+right_pos[2]],model)
                        #cv.imshow('right',
